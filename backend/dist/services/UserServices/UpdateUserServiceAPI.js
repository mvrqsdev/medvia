...
const UpdateUserServiceAPI = async ({ userData, userId }) => {
    ...
    const { email, password, profile, name, queueIds = [], startWork, endWork } = userData;
    try {
...
exports.default = UpdateUserServiceAPI;
