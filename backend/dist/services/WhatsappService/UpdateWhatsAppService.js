...
const UpdateWhatsAppService = async ({ whatsappData, whatsappId, companyId }) => {
    ...
    const { name, status, isDefault, session, greetingMessage, complationMessage, outOfHoursMessage, ratingMessage, queueIds = [], token, timeSendQueue, sendIdQueue = null, } = whatsappData;
    try {
