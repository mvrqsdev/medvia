...
userRoutes.get("/api/users/list", tokenAuth_1.default, UserController.listUsers);
...
userRoutes.put("/api/users/:userId", tokenAuth_1.default, UserController.updateUser);
