...
exports.listUsers = exports.list = exports.remove = exports.updateUser = exports.update = exports.show = exports.store = exports.index = void 0;
...
const UpdateUserServiceAPI_1 = __importDefault(require("../services/UserServices/UpdateUserServiceAPI"));
...
const store = async (req, res) => {
    const { email, password, name, profile, companyId: bodyCompanyId, queueIds, startWork, endWork } = req.body;
...
const updateUser = async (req, res) => {
    try {
        ...
        const userData = req.body;
        const user = await (0, UpdateUserServiceAPI_1.default)({
            userData,
            userId
        });
        ...
        if (Object.keys(err).length === 0) {
            throw new AppError_1.default("Não foi possível atualizar este usuário");
        }
        else {
