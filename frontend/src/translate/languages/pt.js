  ...
  pt: {
    translations: {
      ...
      login: {
        ...
        buttons: {
          submit: "Entrar",
          register: "Primeira vez aqui ? Cadastre-se!",
        },
      },
      companies: {
      ...
      tagModal: {
        title: {
          add: "Novo Marcador/Bucket",
          edit: "Editar Marcador/Bucket",
        },
        form: {
          name: "Nome",
          color: "Cor",
        ...
        success: "Marcador salvo com sucesso.",
      },
      origemModal: {
        title: {
          add: "Nova Origem",
        ...
        success: "Origem salva com sucesso.",
      },
      chat: {
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage: "Todos os dados do atendente serão perdidos. Os atendimentos abertos deste atendente serão movidos para a espera.",
        },
      },
      helps: {
      ...
      tags: {
        title: "Marcadores/Buckets",
        confirmationModal: {
          deleteTitle: "Você tem certeza que quer excluir este Marcador?",
          deleteMessage: "Esta ação não pode ser revertida.",
        },
        table: {
          name: "Nome",
        ...
        toasts: {
          deleted: "Marcador excluído com sucesso.",
        },
      },
      origem: {
        title: "Origem",
        confirmationModal: {
          deleteTitle: "Você tem certeza que quer excluir esta Origem?",
          deleteMessage: "Esta ação não pode ser revertida.",
        },
        table: {
          name: "Nome",
        ...
        toasts: {
          deleted: "Origem excluída com sucesso.",
        },
      },
      settings: {
